...
def visualizeVariationalResults(results, cost_history, seqCmap, divCmap, cubehelix_reverse, save_path=None) -> plt.Figure:
    """
    ...
    barColors = [performance_colors[2], performance_colors[1], performance_colors[0], performance_colors[3]]

    x_pos = np.arange(len(advantage_categories))

    bars7 = ax7.bar(x_pos, scores, 0.5, color=barColors)

    ax7.set_title('Classifier Comparison\n(Same Train/Test Split)', fontsize=14, fontweight='bold', pad=25)
