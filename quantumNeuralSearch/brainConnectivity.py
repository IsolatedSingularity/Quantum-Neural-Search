...
def generateBrainConnectivity(atlasinfo, connectivity_seed=42) -> tuple:
    """
    ...
    edges = rng.normal(0, 0.025, (n_regions, n_regions))
    ...
    for network in atlasinfo['yeo7networks'].unique():
        ...
        if len(network_pairs) > 0:
            ...
            within_network_strength = rng.normal(0.5, 0.05, len(network_pairs))
